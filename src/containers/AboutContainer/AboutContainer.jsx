        ...
        <>
            <section className="section" id={'about'}>
                <div className="container flex min-h-screen flex-col items-center justify-center md:block md:p-4">
                    <h3 className="relative mb-7 text-[64px] font-bold uppercase leading-none text-slate-800 opacity-10 md:absolute md:top-[40%] md:-translate-y-[40%] md:text-[128px] lg:top-[45%] lg:-translate-y-[45%] lg:text-[156px] xl:text-[200px]">
                        About Me
                    </h3>
